...
library — no Homebrew runtime dependency. xz/lzma, lz4, and blake2 are intentionally omitted;
install `fuse-archive` via Homebrew for full format coverage and Rugzak will prefer it automatically
