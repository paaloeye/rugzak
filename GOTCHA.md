...
The bundled build links macOS system libraries (zlib, bzip2, iconv) and a vendored liblzma — no
Homebrew runtime dependency. zstd, lz4, and blake2 are intentionally omitted; install
